...
#
# OVERLAY FILE -- vllm/v1/core/kv_cache_utils.py
# Base: vLLM 0.27.1 as shipped in docker.io/stilldeadcode/vllm-radiance:0.9.3.
# Deviation from that base: ONE hunk, marked "LOCAL PATCH 2026-08-29 ... KV cache
# group padding", adding the KV_GROUP_SIZE / KV_GROUP_MAX_GROUPS environment knobs.
# With KV_GROUP_SIZE unset this file is behaviourally identical to stock.
# Nothing else in the file is modified. Rationale and measurements: TUNING.md.
"""KV-Cache Utilities."""
...
def _get_kv_cache_groups_uniform_page_size(
    ...
    # --- LOCAL PATCH 2026-08-29 (pat/claude): KV cache group padding ---------
    ...
    # per-request budget. Measured on this box: g=5 gives a 222,639-token pool,
    # g=8 gives 269,837 (+21.2%) for the same VRAM -- both measured, not modelled.
    #
    ...
    #                         so we do not trade 6 padded slots for 69 block
