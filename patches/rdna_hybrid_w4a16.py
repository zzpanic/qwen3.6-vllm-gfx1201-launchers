...
_GFX1201_PREFILL_OVERRIDES: dict[tuple[int, int, int, int], tuple[int, int, int, int, int | None]] = {
    # (group_size, K, N, m_bucket) -> (BLOCK_M, BLOCK_N, BLOCK_K, num_warps, num_stages)
    # m_bucket is the bucket's own upper M bound (32/64/128/512), or _GFX1201_MBIG for M>512.
    (32, 17408, 5120, 32): (32, 32, 32, 4, 2),  # down_proj M<=32 (+87.9%)
    (32, 17408, 5120, 64): (64, 32, 32, 4, None),  # down_proj M<=64 (+88.9%)
