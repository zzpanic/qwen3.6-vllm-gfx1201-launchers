...
# HAND-ADAPTED HUNKS (0.26.0 drift): none — one-line addition of
#   "DFlash2DraftModel": ("qwen3_dflash2", "DFlash2Qwen3ForCausalLM") to
#   _SPECULATIVE_DECODING_MODELS. Landed a few entries away from upstream's exact
#   context line (0.26.0 has extra/reordered MTP entries the PR's parent lacked)
#   but inside the same dict, which is all that matters functionally.
"""
